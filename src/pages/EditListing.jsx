      ...
      <main className="max-w-md px-2 mx-auto">
        ...
        <form onSubmit={onSubmit}>
          ...
          <div className="flex space-x-6 mb-6">
            <div>
              {/* BEDS  */}
              <p className="tex-lg font-semibold">Beds</p>
              <input
                type="number"
                id="bedrooms"
                value={bedrooms}
            ...
            {/* BATHS  */}
            <div>
              <p className="tex-lg font-semibold">Baths</p>
              <input
                type="number"
                id="bathrooms"
                value={bathrooms}
            ...
            <div className="flex space-x-6 justify-start mb-6">
              <div>
                ...
                <input
                  ...
                  border-color-gray-300 rounded transition duration-150 ease-in-out 
          ...
          <div className="mb-6">
            ...
            <input
              ...
              border border-color-gray-300 rounded transition duration-150 ease-in-out
